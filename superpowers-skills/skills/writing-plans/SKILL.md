...
**Context:** If working in an isolated worktree, it should have been created via the `superpwr-using-git-worktrees` skill at execution time.
...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpwr-subagent-driven-development (recommended) or superpwr-executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- **REQUIRED SUB-SKILL:** Use superpwr-subagent-driven-development

**If Native chosen:**
- **REQUIRED SUB-SKILL:** Use superpwr-executing-plans
