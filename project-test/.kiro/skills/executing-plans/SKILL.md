...
- You have a plan from superpwr-writing-plans and your human partner
...
- Tasks are mostly independent — the same precondition as
  superpwr-subagent-driven-development.
...
Prefer superpwr-subagent-driven-development when your human partner
...
digraph process {
    ...
    "Use superpwr-finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Final review clean: delete this plan's workspace" -> "Use superpwr-finishing-a-development-branch";
}
```
...
superpwr-using-git-worktrees to create one or verify the existing one.
...
The workspace and ledger are shared with superpwr-subagent-driven-development
...
**REQUIRED SUB-SKILL:** load superpwr-test-driven-development now,
...
order under superpwr-test-driven-development, loaded at setup. A test
...
- **Matches.** Next step.
- **The code is wrong.** Use superpwr-systematic-debugging. Find the
...
**REQUIRED SUB-SKILL:** superpwr-verification-before-completion governs
...
superpwr-requesting-code-review's
...
Use superpwr-finishing-a-development-branch.
...
Using superpwr-finishing-a-development-branch.
```
